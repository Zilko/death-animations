...
public:
    ...
    void firstStep(float) {
        ...
        CCLabelBMFont* lbl = CCLabelBMFont::create(stopCodes[Utils::getRandomInt(0, stopCodes.size() - 1)], "segoe-light.fnt"_spr);
        lbl->setOpacity(190);
        lbl->setScale(0.2f);
